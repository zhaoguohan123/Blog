...
int WINAPI MyMessageBox(HWND hWnd, LPCWSTR lpText,LPCWSTR lpCaption,UINT uType)
{
    ...
    return pTrueMessageBox(NULL, TEXT("This message has been detoured"), lpCaption,MB_OK);
}
...
LONG AttachDetours(VOID)
{
    ...
    ATTACH(&(PVOID&)pTrueMessageBox, MyMessageBox);
...
LONG DetachDetours(VOID)
{
    ...
    DETACH(&(PVOID&)pTrueMessageBox, MyMessageBox);
